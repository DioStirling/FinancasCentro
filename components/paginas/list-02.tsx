...
const categoryStyles = {
  ...
  materiais: "bg-zinc-100 dark:bg-zinc-800 text-zinc-900 dark:text-zinc-100",
  doacao: "bg-zinc-100 dark:bg-zinc-800 text-zinc-900 dark:text-zinc-100",
  contribuicao: "bg-zinc-100 dark:bg-zinc-800 text-zinc-900 dark:text-zinc-100",
}

const TRANSACTIONS: Transaction[] = [
  {
    id: "1",
    title: "Compra de Velas",
    amount: "R$ 45,00",
    type: "outgoing",
    category: "materiais",
    icon: Candle,
  ...
  {
    id: "4",
    title: "Doação - João Santos",
    amount: "R$ 50,00",
    type: "incoming",
    category: "doacao",
    icon: Gift,
    timestamp: "Ontem, 19:45",
    status: "completed",
  },
  {
    id: "5",
    title: "Flores para Gira",
    amount: "R$ 25,00",
    type: "outgoing",
    category: "materiais",
    icon: ShoppingCart,
      ...
      <div className="p-4">
        <div className="flex items-center justify-between mb-3">
          <h2 className="text-sm font-semibold text-zinc-900 dark:text-zinc-100">
            Atividades Recentes
            <span className="text-xs font-normal text-zinc-600 dark:text-zinc-400 ml-1">(23 transações)</span>
          </h2>
          <span className="text-xs text-zinc-600 dark:text-zinc-400">Este Mês</span>
        </div>
